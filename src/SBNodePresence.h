...
class SBNodePresence
{
 ...
 public:
  SBNodePresence() : m_bxs{new boolexpr::Array({s_zero, s_zero, s_zero, s_zero})}, m_sequenced_before_pseudo_value_computation(false) { }
  ...
  boolexpr::bx_t provides_sequenced_after_value_computation() const { return (*m_bxs)[sequenced_after_value_computation_]; }
  boolexpr::bx_t provides_sequenced_after_side_effect() const { return (*m_bxs)[sequenced_after_side_effect_]; }
  ...
  bool update_sequenced_after_value_computation(bool node_provides, boolexpr::bx_t sequenced_after_value_computation);
  bool update_sequenced_after_side_effect(bool node_provides, boolexpr::bx_t sequenced_after_side_effect);
